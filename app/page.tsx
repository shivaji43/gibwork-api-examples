  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 to-violet-100 overflow-hidden">
      ...
      <a
            ...
            className="absolute top-0 right-0 flex items-center gap-2 mx-60 mt-6 px-4 py-2 
            ...
            font-medium"
            >
            <span className="text-inherit"><b>GITHUB</b></span>
      ...
      <div className="flex flex-col items-center justify-center mt-20 h-[calc(100vh-120px)]">
        ...
        >
          <div className="flex items-center justify-center mb-4">
            <SparklesText className="text-4xl md:text-6xl font-bold text-violet-900 mr-4" text="GIBWORK API EXAMPLE APP" />
            <motion.button 
