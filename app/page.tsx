    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 to-violet-100 overflow-hidden">
      <div className="relative">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-black">gibwork</h2>
        </motion.div>
        <motion.a
      ...
      className="absolute top-0 right-0 flex items-center gap-2 mx-60 px-4 py-2 
